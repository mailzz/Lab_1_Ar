...
namespace WebApplication2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IUniversityManager, UniversityManager>();
            services.AddTransient<IProfessorsManager, ProfessorsManager>();
            services.AddTransient<IGroupsManager, GroupsManager>();
            services.AddTransient<ISectionsManager, SectionsManager>();
            services.AddTransient<IDirectionsManager, DirectionsManager>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=University}/{action=University}/{id?}");
            });
        }
    }
}
